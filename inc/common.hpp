...
// DTHREAD AND WARP WRITE LOCATIONS
#define WRITE_WARP_TASKS *dd->WTASKS_SIZE * WARP_IDX
#define WRITE_WARP_TASKS_OFFSET *dd->WTASKS_OFFSET_SIZE * WARP_IDX
#define WRITE_WARP_CLQIUES *dd->WCLIQUES_SIZE * WARP_IDX
#define WRITE_WARP_CLIQUES_OFFSET *dd->WCLIQUES_OFFSET_SIZE * WARP_IDX
#define WRITE_WARP_VERTICES *dd->WVERTICES_SIZE * WARP_IDX
#define WRITE_LANE_VERTICES WRITE_WARP_VERTICES + ((*dd->WVERTICES_SIZE / WARP_SIZE) * LANE_IDX)
